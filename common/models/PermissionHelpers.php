...
use common\models\ValueHelpers; use yii;
 ...
 */
	public static function userMustBeOwner($model_name, $model_id) {
		...
		$sql = "SELECT id FROM $model_name WHERE user_id=:userid AND id=:model_id"; $command = $connection->createCommand($sql); $command->bindValue(":userid", $userid);
